...
class CoinGeckoProvider:
    ...
    def get_market_data(symbols=["bitcoin", "ethereum"], vs_currency="usd"):
        """Ambil data multiple coins sekaligus"""
        try:
...
class KucoinProvider:
    ...
    def _create_signature(self, method, endpoint, body=""):
        """Buat signature untuk autentikasi KuCoin"""
...
class CryptoPanicProvider:
    """Provider berita crypto dari CryptoPanic"""
    ...
    def get_news(self, symbol="BTC", filter="rising"):
        """
        Ambil berita terbaru untuk simbol tertentu
        ...
        try:
            ...
            return {
                ...
                "news": data['results'][:3],  # 3 berita teratas
                "timestamp": time.time(),
                "source": "CryptoPanic"
            }
        except Exception as e:
